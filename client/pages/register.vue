<template>
    <div class="container">
        <h1>ثبت نام</h1>
        <div v-if="success" style="color: green">اطلاعات ثبت شد</div>
        <div>
            <h2>اطلاعات فردی:</h2>
            <br />
            <label>نام کاربری: </label>
            <input class="my-1" type="text" v-model="user.username" placeholder="نام کاربری">
            <br />
            <label>نام: </label>
            ...
            <select v-model="user.type">
                <option value="client">بیمار</option>
